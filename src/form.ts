        ...
        <article class="layout__main">
            <header class="main__header">
                ...
                <p class="main__breadcrumb">
                    ...
                    <a class="main__breadcrumb__item" href="/${config.version}/form.html"><i class="lnir lnir-pencil"></i> フォーム</a>
                </p>
            </header>
                ...
                <div>
                    ...
                    <section class="box__body">
                        ...
                        <dt class="form__header">radio block</dt>
                            <dd class="form__field">
                                <label class="input__radio input__radio_block input_checked"><input type="radio" name="radio-block" checked/>作業中</label>
                        ...
                        <dl class="form">
                            ...
                            <dd class="form__field">
                                <label class="input__checkbox input__checkbox_block input_checked"><input type="checkbox" checked/>作業中</label>
