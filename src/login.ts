        ...
        <article class="layout__main">
            <header class="main__header">
                ...
                <p class="main__breadcrumb">
                    ...
                    <a class="main__breadcrumb__item" href="/${config.version}/index.html"><i class="lnir lnir-enter"></i> ログイン</a>
                </p>
            </header>
        ...
        function modal() {
            ...
            return html`
                <aside class="login" onClick="${resetAll}" data-modal="true">
                    ${state.login.forget.active ? forget() : login()}
                </aside>
            `
        }
                ...
                if (state.login.connecting) {
                    return html`
                        <div class="loading loading_login">
                            ...
                            <p class="loading__message">
                                (この画面では待っていても認証完了にならないので、灰色の部分をクリックして戻ってください)
                            </p>
                        </div>
                    `
                }
                return html`
                    <section class="login__body">
                        ...
                        <dl class="form form_error">
                            ...
                            <dd class="form__field">
                                <input type="password" class="input_fill" id="password" onInput="${passwordInput}"/>
